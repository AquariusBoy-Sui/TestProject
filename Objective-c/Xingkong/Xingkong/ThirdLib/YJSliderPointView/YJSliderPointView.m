...
-(void)SetupUI{
    ...
    /**默认的是升序*/
    _itemarray= @[@"0",@"6",@"12",@"18",@"24"].mutableCopy;
...
-(void)SetupTip{
    ...
    self.TapTiplable.textColor=[UIColor getlabelColor];
...
- (void)PanEvent:(UIPanGestureRecognizer *)gesture{
    ...
    if (gesture.state == UIGestureRecognizerStateChanged) {
        ...
        minMoney = [NSString stringWithFormat:@"%.1f",(x-TapTip_W/2)*piceMoney+20];
