...
//        _dateP.backgroundColor = [UIColor getSystemBackgroundColor];
         _dateP.backgroundColor =getColor(@"797979");
        _dateP.datePickerMode = self.type;
        //在这里更改日期选择器文本颜色！ ↓↓↓↓↓↓
        [_dateP setValue:[UIColor getlabelColor] forKey:@"textColor"];
...
//        self.leftBtn.backgroundColor = [UIColor whiteColor];
          self.leftBtn.backgroundColor =getColor(@"797979");
    }
    return _leftBtn;
}
...
//        self.rightBtn.backgroundColor = [UIColor whiteColor];
        self.rightBtn.backgroundColor =getColor(@"797979");
    }
    return _rightBtn;
}
...
//        _titleLabel.textColor = getColor(@"797979");
        _titleLabel.textColor = [UIColor getlabelColor];
//        _titleLabel.backgroundColor = [UIColor whiteColor];
        _titleLabel.backgroundColor =getColor(@"797979");
...
//        _topView.backgroundColor = [UIColor whiteColor];
         _topView.backgroundColor =getColor(@"797979");
...
//获取当前你选定的时间 格式：Mon Nov 18 11:22:41 2019
